...
\begin{document}
	...
	This chapter will be dedicated to the presentation, as a first step, the environment in which our project was realized considering the efficiency and the quality of the work.\par
	...
	\par The social media also give you the ability to communicate in private with the manager of the place to either pass an order or to ask for more details regarding a specific product.  \par
	\begin{figure}[H]
		\centering
	...
	\subsection{Criticism of the existing solutions}
...
We used the SCRUM design methodology for this project,  which is an agile project management framework used primarily for software development projects to provide a new software capability every 2 to 4 weeks , that allows us to conduct our project well while organizing our work plan \cite{scrumBook}. \par 
	...
	Instead of performing a complete project planning from the start, the work is organized in increments (called sprints) planned as the work progresses. This makes it possible to concentrate efforts on the rapid production of testable and functional elements, while keeping a certain flexibility with respect to the hazards that may arise.\par
	\begin{figure}[H]
		\centering
	...
	\end{table}
	\clearpage
	\section{General use case diagrams}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=7in,keepaspectratio]{class.png}
	...
	\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{|  p{3cm}|  p{1cm}| p{4cm}|  p{1cm}| p{6cm}|}
				...
				&				                      
				1.1.A &                        
				Make the diagrams needed for this \ac{us} (use case diagram, sequence diagram).
				\\ 
				\cline{4-5}    
				&                   
			      &                                 
...
\begin{figure}[H]
	\centering
	\vspace*{1in}
	\subfloat[View profile interface]{{\includegraphics[width=7cm]{profilemobile.jpg} }}%
	\qquad
	\subfloat[Edit profile interface]{{\includegraphics[width=7cm]{editprofilemobile.jpg} }}%
...
\begin{figure}[H]
	\centering
	\vspace*{1in}
	\subfloat[View list of pastries Interface]{{\includegraphics[width=7cm]{pastriesListmobile.jpg} }}%
	\qquad
	\subfloat[View one pastry Interface]{{\includegraphics[width=7cm]{showpastrymobile.jpg} }}%
...
\end{figure}
\clearpage
	\section{Release retrospectives}
